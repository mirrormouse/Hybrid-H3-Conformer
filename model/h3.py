...
from H3.src.models.ssm.ss_kernel import SSKernel

try:
    from H3.src.ops.fftconv import fftconv_func
except ImportError:
    fftconv_func = None
...
class H3Module(nn.Module):
    ...
    def __init__(
            ...
            dropout_p=0.0,   # Just to absorb the kwarg
            layer_idx=None,
